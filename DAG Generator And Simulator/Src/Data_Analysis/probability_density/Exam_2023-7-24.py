...
addr_list1 = 'D:/github/DAG_Scheduling_Summary/Data_Process/Data/7-23/7-23-hi_f2_workload.csv'
...
# sns.histplot(LP5_c1_surpass_rade, kde=True, color='green')
# sns.histplot(LP6_c1_surpass_rade, kde=True, color='pink')
